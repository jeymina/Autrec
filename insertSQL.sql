...
INSERT INTO `option` (`opt_id`, `opt_nom`) VALUES ('1', 'Sans oignons');
INSERT INTO `option` (`opt_id`, `opt_nom`) VALUES ('2', 'Cuisson à point');
INSERT INTO `option` (`opt_id`, `opt_nom`) VALUES ('3', 'Cuisson saignante');
INSERT INTO `option` (`opt_id`, `opt_nom`) VALUES ('4', 'Sans Tomates');
INSERT INTO `option` (`opt_id`, `opt_nom`) VALUES ('5', 'Sauce au Bleu');
INSERT INTO `option` (`opt_id`, `opt_nom`) VALUES ('6', 'Sauce Mayo');
INSERT INTO `option` (`opt_id`, `opt_nom`) VALUES ('7', 'Sauce Ketchup');
